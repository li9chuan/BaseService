...
MACRO(NL_SETUP_BUILD)
  ...
  IF(MSVC)
    ...
    ADD_PLATFORM_FLAGS("/D_CRT_SECURE_NO_DEPRECATE /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS /D_SCL_SECURE_NO_WARNINGS /DWIN32 /D_WINDOWS /Zm500 /wd4250")
...
MACRO(EVA_SETUP_PREFIX_PATHS)
  ...
  IF(NOT EVA_ETC_PREFIX)
    ...
    ELSE(WIN32)
      SET(EVA_ETC_PREFIX "etc/eva" CACHE PATH "Installation path for configurations")
    ENDIF(WIN32)
  ENDIF(NOT EVA_ETC_PREFIX)
  ...
  IF(NOT EVA_SHARE_PREFIX)
    ...
    ELSE(WIN32)
      SET(EVA_SHARE_PREFIX "share/eva" CACHE PATH "Installation path for data.")
    ENDIF(WIN32)
  ENDIF(NOT EVA_SHARE_PREFIX)
